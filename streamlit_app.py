...
if main_mode == "Day Practice Mode":
    ...
    if day_mode == "Flashcard Mode":
        ...
        if st.button("Delete All Day Practice Mistake History"):
            if clear_day_mistakes(DAY_MISTAKES_FILE):
                st.success("✅ All day mistakes have been cleared.")
            else:
                st.info("No day mistakes to clear yet.")
